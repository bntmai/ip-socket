...
export default function auth(state = initialState, action) {
    ...
    switch (action.type) {
        ...
        case 'LOGIN_SUCCESSFUL':
            sessionStorage.setItem("access_token", action.data["result"]['access_token']);
            sessionStorage.setItem("id", action.data["result"]['id']);
            sessionStorage.setItem("email", action.data["result"]['email']);
            sessionStorage.setItem("dob", action.data["result"]['dob']);
            console.log('Hi')
